...
//   const correctAnswers = 13;
  ...
  const options = {
    plugins: {
      legend: {
        display: false, // Hide the legend to match the example
      },
      tooltip: {
        callbacks: {
...
<div className='flex  justify-between' >
      ...
      <p>
          You scored {correctAnswers} question{correctAnswers > 1 ? 's' : ''} correct out of {totalQuestions}.However it still needs some improvements
        </p>

</div>
      <div className='p-4' style={{ position: 'relative', width: '300px', margin: 'auto' }}>
